...
{
    nw::GffInputArchive g{"test_data/user/scratch/creaturepalstd.itp"};
    nw::Palette c{g};
    ...
    nw::GffInputArchive g2{"test_data/user/scratch/creaturepal.itp"};
    nw::Palette p2{g2};
    REQUIRE(p2.valid());
...
{
    nw::GffInputArchive g{"test_data/user/scratch/tde01palstd.itp"};
    nw::Palette c{g};
    REQUIRE(c.valid());
    REQUIRE(c.root.children.size() > 0);
}
...
TEST_CASE("palette: to json")
{
    ...
    nw::GffInputArchive g2{"test_data/user/scratch/creaturepalstd.itp"};
    nw::Palette c2{g2};
