...
class Door(ObjectBase):
    ...
    trap: Trap
    @staticmethod
    def from_dict(self, dictionary: dict) -> Door: ...
    @staticmethod
    def from_file(self, path: str) -> Door: ...
    def to_dict(self, arg0) -> dict: ...
    def save(self, path: str, format: str = "json") -> None: ...
...
class Encounter(ObjectBase):
    ...
    def __init__(self) -> None: ...
    @staticmethod
    def from_dict(self, *args, **kwargs) -> Encounter: ...
    @staticmethod
    def from_file(self, *args, **kwargs) -> Encounter: ...
    def to_dict(self, arg0) -> dict: ...
    @property
...
class Placeable(ObjectBase):
    ...
    @staticmethod
    def from_dict(self, *args, **kwargs) -> Placeable: ...
    @staticmethod
    def from_file(self, *args, **kwargs) -> Placeable: ...
    def to_dict(self, arg0) -> dict: ...
    def save(self, path: str, format: str = "json") -> None: ...
...
class Player(Creature):
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_dict(self, *args, **kwargs) -> Player: ...
    @staticmethod
    def from_file(self, *args, **kwargs) -> Player: ...
    def save(self, path: str, format: str = "json") -> None: ...
...
class Sound(ObjectBase):
    ...
    def __init__(self) -> None: ...
    @staticmethod
    def from_dict(self, *args, **kwargs) -> Sound: ...
    @staticmethod
    def from_file(self, *args, **kwargs) -> Sound: ...
    def to_dict(self, arg0) -> dict: ...
    def save(self, path: str, format: str = "json") -> None: ...
...
class Store(ObjectBase):
    ...
    def __init__(self) -> None: ...
    @staticmethod
    def from_dict(self, *args, **kwargs) -> Store: ...
    @staticmethod
    def from_file(self, *args, **kwargs) -> Store: ...
    def to_dict(self, arg0) -> dict: ...
    @property
...
class Trigger(ObjectBase):
    ...
    def __init__(self) -> None: ...
    @staticmethod
    def from_dict(self, *args, **kwargs) -> Trigger: ...
    @staticmethod
    def from_file(self, *args, **kwargs) -> Trigger: ...
    def to_dict(self, arg0) -> dict: ...
    def save(self, path: str, format: str = "json") -> None: ...
