...
json frame_stats_json(const nw::render::viewer::ViewerFrameStats& stats)
{
    return {
        ...
        {"counts", {
                       ...
                       {"shadow_static_batches", stats.shadow_static_batch_count},
                       {"shadow_static_batched_models", stats.shadow_static_batched_model_count},
                       {"shadow_static_batch_draws", stats.shadow_static_batch_draw_count},
                       ...
                       {"local_shadow_static_batches", stats.local_shadow_static_batch_count},
                       {"local_shadow_static_batched_models", stats.local_shadow_static_batched_model_count},
                       {"local_shadow_static_batch_draws", stats.local_shadow_static_batch_draw_count},
    ...
    const std::filesystem::path& screenshot_path)
{
    ...
    json report{
        ...
        {"summary", {
            ...
            {"static_batches", {
                {"shadow_batches", counter_summary([](const auto& stats) { return static_cast<uint64_t>(stats.shadow_static_batch_count); })},
                {"shadow_models", counter_summary([](const auto& stats) { return static_cast<uint64_t>(stats.shadow_static_batched_model_count); })},
                {"shadow_draws", counter_summary([](const auto& stats) { return static_cast<uint64_t>(stats.shadow_static_batch_draw_count); })},
                {"local_shadow_batches", counter_summary([](const auto& stats) { return static_cast<uint64_t>(stats.local_shadow_static_batch_count); })},
                {"local_shadow_models", counter_summary([](const auto& stats) { return static_cast<uint64_t>(stats.local_shadow_static_batched_model_count); })},
                {"local_shadow_draws", counter_summary([](const auto& stats) { return static_cast<uint64_t>(stats.local_shadow_static_batch_draw_count); })},
            }},
            {"area_frame", {
