...
// Projects one C++-owned rules table into ascending authoring rows. The output
// owns every string and remains valid until it is replaced or cleared. Invalid
// source rows are dropped; an unsupported or oversized source replaces output
// with an unavailable catalog and a diagnostic.
