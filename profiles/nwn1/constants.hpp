...
constexpr nw::ModifierType mod_type_damage_mode = nw::ModifierType::make(21);
constexpr nw::ModifierType mod_type_damage_special_attack = nw::ModifierType::make(22);
